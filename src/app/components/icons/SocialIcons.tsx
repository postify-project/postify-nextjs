...
export function YoutubeIcon({ className = "h-4 w-4 text-red-500" }: { className?: string }) {
  return (
...
export function LinkedinIcon({ className = "h-4 w-4 text-blue-500" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function FacebookIcon({ className = "h-4 w-4 text-blue-600" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export function InstagramIcon({ className = "h-4 w-4 text-pink-500" }: { className?: string }) {
  return (
