      ...
      >
        ...
        <div className="pt-2 px-1">
          <button
            ...
            className="w-full flex items-center gap-3 rounded-2xl px-3.5 py-2.5 text-xs font-semibold text-rose-600 hover:bg-rose-50 hover:text-rose-700 transition-all duration-200 cursor-pointer disabled:opacity-50 border border-transparent hover:border-rose-200/60"
          >
