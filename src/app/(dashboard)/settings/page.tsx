    ...
    <div className="w-full text-white antialiased">
      ...
      <header className="mb-8">
        ...
        <p className="mt-1 text-sm text-neutral-400">
          Fine-tune system variables, credentials mode, throttle bounds, and locking intervals
        </p>
      </header>

      <form onSubmit={handleSubmit} className="flex flex-col gap-[18px] max-w-[760px]">
